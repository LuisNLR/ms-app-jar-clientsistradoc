 ...
 * @author USER
 */
public class DialogRegistrarTarea extends javax.swing.JDialog {

    /**
     * Creates new form DialogRegistrarActividades
     */
    public DialogRegistrarTarea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initProcess();
    }
    
    public DialogRegistrarTarea(java.awt.Frame parent, boolean modal, LoginResponseDTO loginResponseDTO) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblDependencia, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE)
                    .addComponent(lblArea, javax.swing.GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de trámites por atender"));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtSolicitante, javax.swing.GroupLayout.DEFAULT_SIZE, 383, Short.MAX_VALUE))
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(cbTipoTarea, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogRegistrarTarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogRegistrarTarea dialog = new DialogRegistrarTarea(new javax.swing.JFrame(), true);
    ...
    public void nuevo() {
        ...
        txtTarea.setText("");
        cbTipoTarea.setSelectedIndex(0);
    ...
    private void loadTramiteToDeriverByDependency() {
        ...
        listTramite = queryTramite.listTramitesToAttendByDependency(loginResponseDTO.getIdDependencia());
        //String cabecera[] =  {"COD. TRAMITE", "TIPO TRAMITE", /*"ASUNTO", */"SOLICITANTE", "FLUJO A REALIZAR"};
        for(TramiteQuerysDTO t : listTramite) {
            String data[] = {t.getCodigoTramite(), t.getTipoTramite(), /*t.getAsunto(), */t.getSolicitante(), t.getFlujoRealizar()};
    ...
    private TramiteTareaDTO cargarDatos() {
        TramiteDTO tramiteDto = new TramiteDTO("TR0000");
        if(rowNumSelected>=0) {
            tramiteDto = new TramiteDTO(listTramite.get(rowNumSelected).getCodigoTramite());
        }
        String descripcionTarea = txtTarea.getText();
        String tipoTarea = cbTipoTarea.getSelectedItem().toString();
        TramiteMovimientoDTO tramiteMovimientoDto = new TramiteMovimientoDTO(tramiteDto);
        TramiteTareaDTO tarea = new TramiteTareaDTO(descripcionTarea, tipoTarea, tramiteMovimientoDto);
        return tarea;
    }
    
    private void procesar() {
        HttpResponse<String> response = serviceTramite.registerActivity(cargarDatos());
